...
export var BubbleChatDialog = function (props) {
    var _a;
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Dialog, { styles: {
            ...
            React.createElement("div", { id: "chatContainer", style: {
                    display: "flex",
...
var Chatbot = /** @class */ (function (_super) {
    ...
    Chatbot.prototype.render = function () {
        return (React.createElement("div", { style: {
            ...
            React.createElement(BubbleChatDialog, __assign({}, this.props))));
    };
    return Chatbot;
}(React.Component));
export default Chatbot;
//# sourceMappingURL=BubbleChatDialog.js.map