...
- Add a Federated Credentials in **Certificate & Secrets** : In your App Registration, go to Certificates & secrets > Federated credentials > Add credential.
  ...
  - Organization: Your GitHub org (e.g., **ExtraSpaceStorage**)
  - Repository: Your repo name (e.g., **extraspace.ai.itselfservice.spfx**)
  - Entity type: **Branch**
  - Branch: **main** 
  - Subject identifier: repo:ExtraSpaceStorage/extraspace.ai.itselfservice.spfx:ref:refs/heads/main
